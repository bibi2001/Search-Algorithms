...
public abstract class SearchAlgorithm {
	...
	public List<Node> startSearch(Node n_initial, Node n_final) {
		...
		//No caso dos argumentos serem inválidos, devolve uma Node com o label que explica a situção
		if(n_initial==null || n_final==null) {
			result.add(new Node("Invalid arguments"));
			return result;
		}
		
		//movi este código para aqui para não estar repetido nos testes
